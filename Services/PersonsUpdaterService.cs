...
namespace Services
{
  public class PersonsUpdaterService : IPersonsUpdaterService
  {
    ...
    //constructor
    public PersonsUpdaterService(PersonsDbContext personsDbContext, ICountriesService countriesService)
    {
    ...
    public bool DeletePerson(Guid? personID)
    {
      ...
      _db.Persons.Remove(_db.Persons.First(temp => temp.PersonID == personID));
        ...
        public async Task<MemoryStream> GetPersonsExcel()
        {
            ...
            {
                ExcelWorksheet excelWorksheet = excelPackage.Workbook.Worksheets.Add("Persons");
                excelWorksheet.Cells.LoadFromCollection(_db.Persons.Select(temp => temp.ToPersonResponse()), true);
